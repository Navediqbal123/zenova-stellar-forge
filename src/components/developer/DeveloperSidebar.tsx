...
export function DeveloperSidebar({ onUploadClick }: DeveloperSidebarProps) {
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col p-4">
        ...
        <Button
          ...
          className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-muted border border-white/10 hover:bg-primary/20 z-50"
        >
          {collapsed ? (
