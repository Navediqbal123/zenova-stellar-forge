    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex flex-col gap-4">
        ...
        <p className="text-muted-foreground">
          Discover and download the best applications
        </p>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="glass-card p-4">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <Select value={selectedCategory} onValueChange={setSelectedCategory}>
            <SelectTrigger className="w-full lg:w-48 bg-muted/50 border-muted">
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Showing <span className="text-foreground font-medium">{filteredApps.length}</span> apps
        </p>
      </motion.div>
      ...
      {filteredApps.length === 0 ? (
        <motion.div variants={itemVariants} className="glass-card p-12 text-center">
          <p className="text-xl text-muted-foreground mb-4">No apps found</p>
          <p className="text-sm text-muted-foreground">
              ...
              <Link to={`/apps/${app.id}`}>
                <div className="glass-card p-4 hover-glow transition-all duration-300 group">
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 shrink-0">
                      {app.icon}
                    </div>
                    <div className="flex-1 min-w-0">
