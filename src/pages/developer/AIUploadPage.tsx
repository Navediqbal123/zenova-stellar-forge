                  ...
                  <div>
                    ...
                    <div className="p-4 rounded-xl bg-white/[0.03] border border-white/10 space-y-4">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="relative">
                            <img
                              ...
                              className="w-20 h-20 rounded-2xl object-cover border-2 border-primary/20 shadow-lg shadow-primary/10"
                            />
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">Auto-generated by AI</p>
                          </div>
                        </div>
                      )}
                      ...
                      {aiResult.screenshot_urls.length > 0 && (
                        <div>
                          <p className="text-sm font-medium mb-2">Screenshots ({aiResult.screenshot_urls.length})</p>
                          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            {aiResult.screenshot_urls.map((url, i) => (
                              <motion.div
                                ...
                                className="relative aspect-[9/16] rounded-lg overflow-hidden border border-white/10 group"
                              >
                                <img
                                  src={url}
                                  alt={`Screenshot ${i + 1}`}
                                ...
                                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/60 to-transparent p-2">
                                  <span className="text-[10px] text-white/80">Screenshot {i + 1}</span>
                                </div>
                              </motion.div>
                            ))}
                          </div>
